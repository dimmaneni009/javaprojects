...
public class Library {
	...
	public static void insertbookdetails(int id, String TITTLE, String Author, String Username) {
		...
		String sql = "INSERT INTO books (id,TITTLE, Author, Username) VALUES (" + id + " ,+'" + TITTLE + "', '" + Author
				+ "', '" + Username + "');";
	...
	private static void updateBookInDatabase(int Id, String TITTLE, String Author, String Username) {
		String sql = "UPDATE books SET title = '" + TITTLE + "', Author = '" + Author + "', username = '" + Username
				+ "' WHERE id = " + Id + ";";
 ...
 * 
 * private Connection getConnection() { //try return null; } private Statement
 * getStatement(Connection con2) {
 * 
 * //tryblock return null; }
 */
